...
○ Método: __init__(self, numero_de_rodas). O __init__ deve instanciar um Motor e criar a lista de Rodas com o número especificado.

○ Método: ligar() que chama o método ligar() do motor e depois o método girar() de todas as rodas.
