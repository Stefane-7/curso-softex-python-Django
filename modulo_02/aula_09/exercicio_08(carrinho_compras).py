...
○ Método: adicionar_item(produto, quantidade) que cria um objeto ItemDeCompra e o adiciona na lista.

○ Método: calcular_total() que itera sobre a lista itens e retorna a soma total dos preços (preço do produto * quantidade)."""